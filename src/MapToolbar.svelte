<script>
	...
	// function setShowTemp() {
	// 	console.log(!_showTemp)
	// 	showTemp.set(!_showTemp)
	// }
</script>
...
<div class="mapToolBar">
	<!-- <button
		type="button"
		class="single-click toolBarButton"
	...
	<button
		type="button"
		on:click={() => showTemp.set(!$showTemp)}
		class:selected={!$showTemp}
		class="buttonTool"
		title="Show Temp"
	>
		<svg width="49.17" height="49.17">
